...
<link rel="apple-touch-icon" href="images/img1.png">
<style>
:root {
  --teal: #1A6B72;
  --teal-dk: #0D3F44;
...
.features::before { animation: patternDrift 40s linear infinite; background-image: url('images/img4.png'); background-repeat: repeat; background-size: 500px auto; content: ''; inset: 0; opacity: 0.4; pointer-events: none; position: absolute; z-index: 0; }
...
<nav class="site-nav" id="site-nav" aria-label="Primary navigation">
  <a class="brand" href="#top" aria-label="The Muhsinat Club home">
    ...
    <img src="images/img1.png" alt="TMC" class="nav-logo-img">
    ...
    <div class="footer-top">
      <div>
        ...
        <div class="footer-brand-row">
          <img src="images/img1.png" alt="TMC" style="height:44px;object-fit:contain;">
